                ...
                s+=`<div class="col-6 col-lg-3 col-sm-6 col-md-4 col-xl-3 card-product">
                    <a title="${item.ten_san_pham}" href="/${PREFIX_PRODUCT}${item._id}">
                        <div class="item-flash-sale">
                            <div class="img-item-flash-sale" style="background-image: ${item.anh_faa})">
...
var BuildIteamProduct = (item)=>{
    let range = FindPriceRange(item);
    let path_image = URL_HOST +"uploads/"+JsonParseStr(item.cua_hang_id)+"/"+JsonParseStr(item._id)+"/"+item.anh_faa;
                ...
                <div class="row">
                    <div class="col-lg-5 col-12">
                        <div class="box-detail-product-left">
                            <div id="main-image-product" class="main-img-product" style="background: url(${path}${data.anh_faa}); background-size:cover;">
                            </div>
                        ...
                        <div class="box-detail-product-right">
                            ...
                            //var giaTienBanDau = giaTienDaDinhDang.replace(/[^\d,.-]/g, '');                   
                                ...
                                {           
                                    ...
                                    s+=`<h3 ><span id="item-price" class="item-price-value">${GetPriceMinMax(range.min,range.max)}</span><span style="text-decoration: underline">đ</span></h3>`                                                                                                                                                                                                                                                                 
                                s +=`<br><br>
