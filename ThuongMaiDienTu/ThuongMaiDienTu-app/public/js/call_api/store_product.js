                    ...
                    var row = $(`<tr class="tr-product">
                                    <td class="td-click">
                                        <a class="item-product-link" href="${URL_HOST+PREFIX_STORE+PREFIX_PRODUCT+san_pham_id}">
                                            <center><div  style="background: url(http://shopbee.local/FE/img/product-img/product-1.jpg); background-size:cover; width: 80px; height: 100px;"></div></center>
                                            <center><strong title="@item.TenSP">${item.ten_san_pham}</strong></center>
                                        </a>
                                    </td>                                        
